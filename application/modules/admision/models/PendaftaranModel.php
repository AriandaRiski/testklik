...
class PendaftaranModel extends CI_Model
{
    ...
    var $column_order = array('nama_user','jenis_kelamin','tgl_lahir','no_identitas'); //Sesuaikan dengan field
    var $column_search = array('nama_user','no_identitas'); //field yang diizin untuk pencarian 
