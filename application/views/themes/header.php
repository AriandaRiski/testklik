...
<head>
    ...
    <!-- plugin js -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendors/datatables.net/js/jquery.dataTables.js">
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendors/datatables.net/js/jquery.dataTables.min.js">
